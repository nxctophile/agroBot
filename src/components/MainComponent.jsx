  ...
  return (
    <div id="MainSectionContainer">
      <section id="MainSection">
        <TopBar deleteAll={props.deleteAll} toggleMode={props.toggleMode} />
        <div id="emptyChat">
          <img
            alt="Greeting Bot"
            src="https://static.wixstatic.com/media/14401c_20a0b437b6f344198294dab55e277af0~mv2.gif"
          />
        </div>
        <div id="deletedChat">
          <img
            alt="Messages Deleted"
        ...
        <div id="responseContainer">
          {props.bubbles.map((element, index) => {
            const bubbleClass =
              element.side === "client"
                ? "bubble client"
                : "bubble server" && element.side === "delete"
                ? "bubble delete"
                : "bubble server" && element.side === "image"
                ? "bubble image"
                : "bubble server";
            return (
              <>
